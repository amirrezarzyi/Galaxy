...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin-assets/app-assets/css-rtl/pages/authentication.css')}}">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{asset('admin-assets/app-assets/js/scripts/pages/auth-login.js')}}"></script>    <!-- END: Page JS-->

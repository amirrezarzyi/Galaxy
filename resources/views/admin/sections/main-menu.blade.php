        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <ul class="menu-content">
                    <li class="{{ request()->is('admin/user*') ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="{{ route('admin.user.index') }}">
                            ...
                            <span class="menu-item text-truncate" data-i18n="List">لیست کاربران</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item has-sub">
                <a class="d-flex align-items-center" href="#">
                    ...
                    <span class="menu-title text-truncate" data-i18n="User">فایل ها</span>
                </a>
                <ul class="menu-content">
                    <li class="{{ request()->is('admin/role*') ? 'active' : '' }}">
                        <a class="d-flex align-items-center" href="{{ route('admin.role.index') }}">
                            <i data-feather='circle'></i>
                            <span class="menu-item text-truncate" data-i18n="List">پست ها</span>
                        </a>
                    </li>
                </ul>
            </li>

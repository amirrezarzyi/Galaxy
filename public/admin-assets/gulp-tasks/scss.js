...
module.exports = (gulp, callback) => {
  ...
  const scssStyleTaskRtl = function () {
    return gulp
  ...
  const scssWatchTask = function () {
    return gulp.watch(
      ...
      gulp.parallel(scssCoreTask, scssMainTask, scssPagesTask, scssPluginTask, scssStyleTask, scssStyleTaskRtl, scssThemesTask)
    );
  };
